...
### Ingeniero de Soporte Técnico / Backend & IA

Popayán, Colombia (Remoto) · +57 316 082 2755 · yeisonestivendelgado109@gmail.com
...
- Diagnostiqué y resolví un bug crítico de **contaminación cruzada entre corridas concurrentes**
  (dos procesos pisándose datos), aislando el problema hasta su causa raíz en el manejo de
  archivos temporales, y lo corregí con una arquitectura de aislamiento por `job_id`.
- Reduje rebotes de email implementando verificación de dominio antes de confiar en datos
  externos — diagnóstico proactivo antes de que el problema llegara a producción con clientes.

### Ingeniero y Analista de IA (Freelance) · Remoto · 2025 – 2026
- Trabajo directo con clientes no técnicos: levanté requerimientos, expliqué soluciones técnicas
  en lenguaje simple y resolví incidencias de integración de datos (OmniRetail, Mediscribe).
